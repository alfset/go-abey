...
// Package abeyclient provides a client for the Ethereum RPC API.
package abeyclient
...
func (ec *Client) SnailBlockByHash(ctx context.Context, hash common.Hash) (*rpcSnailBlock, error) {
	return ec.getSnailBlock(ctx, "abey_getSnailBlockByHash", hash, true)
}
...
func (ec *Client) SnailBlockByNumber(ctx context.Context, number *big.Int) (*rpcSnailBlock, error) {
	return ec.getSnailBlock(ctx, "abey_getSnailBlockByNumber", toBlockNumArg(number), true)
}
...
func (ec *Client) FruitByHash(ctx context.Context, hash common.Hash, fullSigns bool) (*rpcFruit, error) {
	return ec.getFruit(ctx, "abey_getFruitByHash", hash, fullSigns)
}
...
func (ec *Client) FruitByNumber(ctx context.Context, number *big.Int, fullSigns bool) (*rpcFruit, error) {
	return ec.getFruit(ctx, "abey_getFruitByNumber", toBlockNumArg(number), fullSigns)
}
...
func (ec *Client) SnailHeaderByHash(ctx context.Context, hash common.Hash) (*rpcSnailHeader, error) {
	...
	err := ec.c.CallContext(ctx, &head, "abey_getSnailBlockByHash", hash, false)
	if err == nil && head == nil {
		err = abeychain.NotFound
	}
	return head, err
}
...
func (ec *Client) SnailHeaderByNumber(ctx context.Context, number *big.Int) (*rpcSnailHeader, error) {
	var head *rpcSnailHeader
	err := ec.c.CallContext(ctx, &head, "abey_getSnailBlockByNumber", toBlockNumArg(number), false)
	if err == nil && head == nil {
		err = abeychain.NotFound
	}
	return head, err
...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return ec.getBlock(ctx, "abey_getBlockByHash", hash, true)
}
...
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
	return ec.getBlock(ctx, "abey_getBlockByNumber", toBlockNumArg(number), true)
}
...
func (ec *Client) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "abey_getBlockByHash", hash, false)
	if err == nil && head == nil {
		err = abeychain.NotFound
	}
	return head, err
...
func (ec *Client) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "abey_getBlockByNumber", toBlockNumArg(number), false)
	if err == nil && head == nil {
		err = abeychain.NotFound
	}
	return head, err
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	err = ec.c.CallContext(ctx, &json, "abey_getTransactionByHash", hash)
	if err != nil {
		return nil, false, err
	} else if json == nil {
		return nil, false, abeychain.NotFound
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "abey_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, "abey_getBlockTransactionCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) FruitCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "abey_getBlockFruitCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, "abey_getTransactionByBlockHashAndIndex", blockHash, hexutil.Uint64(index))
	if err == nil {
		if json == nil {
			return nil, abeychain.NotFound
		} else if _, r, _ := json.tx.RawSignatureValues(); r == nil {
...
func (ec *Client) FruitInBlockByHash(ctx context.Context, snailBlockHash common.Hash, index uint, fullSigns bool) (*rpcFruit, error) {
	var json *rpcFruit
	err := ec.c.CallContext(ctx, &json, "abey_getFruitByBlockHashAndIndex", snailBlockHash, hexutil.Uint64(index), fullSigns)
	return json, err
}
...
func (ec *Client) FruitInBlockByNumber(ctx context.Context, snailBlockNumber *big.Int, index uint, fullSigns bool) (*rpcFruit, error) {
	var json *rpcFruit
	err := ec.c.CallContext(ctx, &json, "abey_getFruitByBlockNumberAndIndex", toBlockNumArg(snailBlockNumber), hexutil.Uint64(index), fullSigns)
	return json, err
}
...
func (ec *Client) TransactionReceipt(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
	var r *types.Receipt
	err := ec.c.CallContext(ctx, &r, "abey_getTransactionReceipt", txHash)
	if err == nil {
		if r == nil {
			return nil, abeychain.NotFound
		}
...
func (ec *Client) SyncProgress(ctx context.Context) (*abeychain.SyncProgress, error) {
	var raw json.RawMessage
	if err := ec.c.CallContext(ctx, &raw, "abey_syncing"); err != nil {
		return nil, err
	}
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (abeychain.Subscription, error) {
...
func (ec *Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "abey_getBalance", account, toBlockNumArg(blockNumber))
	return (*big.Int)(&result), err
}
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "abey_getStorageAt", account, key, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "abey_getCode", account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &result, "abey_getTransactionCount", account, toBlockNumArg(blockNumber))
...
func (ec *Client) FilterLogs(ctx context.Context, q abeychain.FilterQuery) ([]types.Log, error) {
	var result []types.Log
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
	err = ec.c.CallContext(ctx, &result, "abey_getLogs", arg)
	return result, err
}

// SubscribeFilterLogs subscribes to the results of a streaming filter query.
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q abeychain.FilterQuery, ch chan<- types.Log) (abeychain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q abeychain.FilterQuery) (interface{}, error) {
...
func (ec *Client) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "abey_getBalance", account, "pending")
	return (*big.Int)(&result), err
}
...
func (ec *Client) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "abey_getStorageAt", account, key, "pending")
	return result, err
}
...
func (ec *Client) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "abey_getCode", account, "pending")
	return result, err
}
...
func (ec *Client) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "abey_getTransactionCount", account, "pending")
	return uint64(result), err
}
...
func (ec *Client) PendingTransactionCount(ctx context.Context) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "abey_getBlockTransactionCountByNumber", "pending")
	return uint(num), err
}
...
func (ec *Client) PendingFruitCount(ctx context.Context) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "abey_getBlockFruitCountByNumber", "pending")
	return uint(num), err
}
...
func (ec *Client) CallContract(ctx context.Context, msg abeychain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "abey_call", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) PendingCallContract(ctx context.Context, msg abeychain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "abey_call", toCallArg(msg), "pending")
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "abey_gasPrice"); err != nil {
		return nil, err
	}
...
func (ec *Client) EstimateGas(ctx context.Context, msg abeychain.CallMsg) (uint64, error) {
	var hex hexutil.Uint64
	err := ec.c.CallContext(ctx, &hex, "abey_estimateGas", toCallArg(msg))
	if err != nil {
		return 0, err
	}
